...
variable "runbook" {
  ...
  default     = "https://github.com/KitmanLabs/projects/tree/master/engineering/runbook_alarms/dynamo.md"
}

variable "table" {
  description = "The name of the dynamo table to monitor"
}

variable "threshold" {
  description = "The provisioned_write_capacity_units threshold"
}
